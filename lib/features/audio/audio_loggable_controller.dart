...
class AudioLoggableController extends LoggableController<AudioLog> {
  AudioLoggableController({required Loggable loggable, required MainRepository repository})
  ...
  Future<void> updateLog(Log oldLog, Log newLog) async {
    // delete oldLog image
    FilePathHelper.deleteFilePaths((oldLog as ImageLog).filePaths);
