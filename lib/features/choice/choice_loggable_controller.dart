...
class ChoiceLoggableController extends LoggableController<String> {
  ChoiceLoggableController({required Loggable loggable, required MainRepository repository})
