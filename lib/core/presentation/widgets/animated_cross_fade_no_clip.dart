...
/// [AnimatedCrossFadeNoClip] is rebuilt with a different value for the
...
/// [AnimatedCrossFadeNoClip] widget cross-fades between the two forms of the logo
/// over three seconds.
///
/// ```dart
/// AnimatedCrossFade(
...
///  * [AnimatedSize], the lower-level widget which [AnimatedCrossFadeNoClip] uses to
///    automatically change size.
class AnimatedCrossFadeNoClip extends StatefulWidget {
  ...
  ///
  /// By default, this uses [AnimatedCrossFadeNoClip.defaultLayoutBuilder], which uses
  ...
  /// constraints. This works well when the [AnimatedCrossFadeNoClip] is in a position
  ...
  /// [AnimatedCrossFadeNoClip] is being forced to a particular size, then it can
  /// result in the widgets jumping about when the cross-fade state is changed.
  final AnimatedCrossFadeBuilder layoutBuilder;

  /// The default layout algorithm used by [AnimatedCrossFadeNoClip].
  ///
  ...
  @override
  State<AnimatedCrossFadeNoClip> createState() => _AnimatedCrossFadeState();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IntProperty('reverseDuration', reverseDuration?.inMilliseconds,
        unit: 'ms', defaultValue: null));
  }
}

class _AnimatedCrossFadeState extends State<AnimatedCrossFadeNoClip> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(AnimatedCrossFadeNoClip oldWidget) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description
        .add(DiagnosticsProperty<AnimationController>('controller', _controller, showName: false));
